...
> how many cache misses per element does each layout cost, measured?

## The failure question

> what do two counters on the same line do to two cores?
...
a struct of fields → SoA; manual padding → `hardware_destructive_interference_size`
...
| Topic | State |
|---|---|
| `01-soa-vs-aos` — SoA versus AoS | **not started** |
| `02-false-sharing` — false sharing | **not started** |
| `03-small-buffer` — small buffer optimization | **not started** |
