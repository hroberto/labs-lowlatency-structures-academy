...
> at what cardinality does a flat-array search lose to the tree?

## The failure question

> what does a rehash do to the tail?
...
| Topic | State |
|---|---|
| `01-vector-vs-list` — `vector` versus `list` | **not started** |
| `02-flat-map-vs-map` — flat map versus `map` | **not started** |
| `03-open-addressing-vs-unordered` — open addressing versus `unordered_map` | **not started** |
