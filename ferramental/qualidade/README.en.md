...
The first is the only one of the seven that looks at **generated code**. It exists
...
**All seven have a self-test**, and it checks the checker itself against
...
| documentation | the seven checkers **and their seven self-tests** |
