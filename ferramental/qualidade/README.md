...
O primeiro é o único dos sete que olha **código gerado**. Ele existe porque
...
**Os sete têm autoteste**, e ele verifica o próprio verificador contra casos
...
| documentação | os sete verificadores **e os sete autotestes** |
