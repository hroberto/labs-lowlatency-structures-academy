...
| [Module track](docs/README.en.md) | **1 topic out of 31** — [08.01, the harness measuring itself](docs/08-medicao/01-harness/README.en.md) is measured; the ten modules have an index, and the other 30 topics have not been started |
