...
|---|---|---|
| [padrao-do-projeto.en.md](padrao-do-projeto.en.md) | **the standard**: method, measurement, contract, architecture, documentation, sources | **written** |
...
|---|---|
| `plano-estudo-cpp.en.md` | **the canonical study order** — the one the modules will cite |
